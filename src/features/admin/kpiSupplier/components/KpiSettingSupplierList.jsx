...
const KpiSettingSupplierList = ({ list, pagination, filter, onFilter, onDelete }) => {
                        ...
                        list.map((row) => (
                            <TableRow key={row.id}>
                                ...
                                <TableCell component="th">
                                    <Link to={'/admin/kpi-supplier/kpi-setting-supplier/' + row.id}>
                                        {row.name}
                                    </Link>
                                </TableCell>
                                <TableCell>
                                ...
                                >
                                    <BasicButtonStyled
                                        ...
                                        color="primary"
                                        size="small"
                                        onClick={() => navigate('/admin/kpi-supplier/kpi-setting-supplier/' + row.id)}
                                    >
...
export default KpiSettingSupplierList;
