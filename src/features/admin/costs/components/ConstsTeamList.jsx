...
const ConstsTeamList = ({ list, pagination, filter, onFilter, onDelete }) => {
                        ...
                        list.map((row) => (
                            <TableRow key={row.id}>
                                ...
                                <TableCell component="th">
                                    <Link to={'/admin/costs/costs-team/' + row.id}>
                                        {row.name}
                                    </Link>
                                </TableCell>
                                ...
                                >
                                    <BasicButtonStyled
                                        ...
                                        color="primary"
                                        size="small"
                                        onClick={() => navigate('/admin/costs/costs-team/' + row.id)}
                                    >
