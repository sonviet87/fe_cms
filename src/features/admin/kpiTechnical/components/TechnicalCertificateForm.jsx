...
TechnicalCertificateForm.propTypes = {
    initialValue: PropTypes.object,
    onSubmit: PropTypes.func,
};


function TechnicalCertificateForm({ initialValue, onSubmit, itemValue, isEdit }) {
   ...
   const goalsList = [
    ...
    React.useEffect(() => {
        if (isEdit) {
            ...
            setValue('end_date', itemValue.end_date);
            setValue('user_id', itemValue.user_id);
            setValue('goals', itemValue.goals);
    ...
    return (
        ...
        >
            <Grid container spacing={2}>
                <Grid item xs={12} >
                    <TextFormik name="name" label="Tên chứng chỉ"  control={control} />
                </Grid>
                ...
                <Grid item xs={12} md={3} >
                    <BasicSelect name="goals" label="Kết quả" control={control} options={goalsList} />
                </Grid>
...
export default TechnicalCertificateForm;
