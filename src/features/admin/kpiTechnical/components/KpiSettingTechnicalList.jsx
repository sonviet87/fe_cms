...
const KpiSettingTechnicalList = ({ list, pagination, filter, onFilter, onDelete }) => {
                        ...
                        list.map((row) => (
                            <TableRow key={row.id}>
                                ...
                                <TableCell component="th">
                                    <Link to={'/admin/kpi-technical/kpi-setting-technical/' + row.id}>
                                        {row.name}
                                    </Link>
                                </TableCell>
                                <TableCell>
                                ...
                                >
                                    <BasicButtonStyled
                                        ...
                                        color="primary"
                                        size="small"
                                        onClick={() => navigate('/admin/kpi-technical/kpi-setting-technical/' + row.id)}
                                    >
...
export default KpiSettingTechnicalList;
