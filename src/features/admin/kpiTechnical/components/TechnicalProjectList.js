...
export default function TechnicalProjectList({ list, pagination, filter, onFilter, onDelete }) {
            ...
            list.map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell component="th">
                  <Link to={'/admin/kpi-technical/technical-project/' + row.id}>
                    {row.name}
                  </Link>
                </TableCell>
                ...
                >
                  <BasicButtonStyled
                    ...
                    color="primary"
                    size="small"
                    onClick={() => navigate('/admin/kpi-technical/technical-project/' + row.id)}
                  >
