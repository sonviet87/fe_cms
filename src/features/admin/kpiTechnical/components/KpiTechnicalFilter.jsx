...
import {statusKpi} from "../../kpiSale/constants/KpiConstants";


function KpiTechnicalFilter({ loading, filter, onSubmit,methods,memberGroup,onGetKpiSetting }) {
...
export default KpiTechnicalFilter;