...
export default function TechnicalCertificateList({ list, pagination, filter, onFilter, onDelete }) {
            ...
            list.map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell component="th">
                  <Link to={'/admin/kpi-technical/technical-certificate/' + row.id}>
                    {row.name}
                  </Link>
                </TableCell>
                ...
                >
                  <BasicButtonStyled
                    ...
                    color="primary"
                    size="small"
                    onClick={() => navigate('/admin/kpi-technical/technical-certificate/' + row.id)}
                  >
