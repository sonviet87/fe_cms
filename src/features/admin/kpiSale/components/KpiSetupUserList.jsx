...
const KpiSetupUserList = ({ list, pagination, filter, onFilter, onDelete }) => {
            ...
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell>Mục tiêu doanh số tháng</TableCell>
                        <TableCell>Mục tiêu doanh số quý</TableCell>
                        <TableCell>Mục tiêu doanh số năm</TableCell>
                        ...
                        list.map((row) => (
                            <TableRow key={row.id}>
                                ...
                                <TableCell component="th">
                                    <Link to={'/admin/kpi-sale/setup-user/' + row.id}>
                                        {row.name}
                                    </Link>
                                </TableCell>
                                ...
                                >
                                    <BasicButtonStyled
                                        ...
                                        color="primary"
                                        size="small"
                                        onClick={() => navigate('/admin/kpi-sale/setup-user/' + row.id)}
                                    >
                                    ...
                                    <BasicButtonStyled
                                        ...
                                        color="third"
                                        size="small"
                                        onClick={() => navigate('/admin/kpi-sale/setup-user/add?copy=' + row.id)}
                                    >
...
export default KpiSetupUserList;
