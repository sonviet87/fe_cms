...
function KpiFilter({ loading, filter,selectedTypeKpi,setSelectedTypeKpi, onSubmit,methods,memberGroup,setMemberGroup,onGetKpiSetting }) {
    ...
    const handleDateChange = async (date) => {
        ...
        if(!startDay || startDay.year() !== date.year()) {
