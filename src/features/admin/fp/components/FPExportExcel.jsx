...
const FPExportExcel = ({ data }) => {
    ...
    const exportSimpleExel = async () => {
        console.log(data)
        const workbook = new ExcelJS.Workbook();
        const ws = workbook.addWorksheet('PAKD');
        const headers = [
            { header: 'ID', key: 'fn', width: 15 },
            { header: 'Name', key: 'ln', width: 15 },
            { header: 'Parent Name', key: 'occ', width: 15 },
            { header: 'Class room', key: 'sl', width: 15 },
            { header: 'Subject', key: 'subject', width: 15 },
            { header: 'Division', key: 'dvi', width: 15 },
    ...
    return (
        <Button
            ...
            size="small"
            onClick={() => {
                exportToExcel("testExecl", "PAKD", "Báo cáo", headers, [
                    { width: 15 },
                    { width: 15 },
                    { width: 30 },
                    { width: 20 },
